...
Dependency dependency(String, String):: Adds a dependency by name.
Dependency dependency(String, Action<? super DependencySpec>):: Adds and configures a dependency by name.
Dependency dependency(String, Closure<Void>):: Adds and configures a dependency by name.
Dependency dependency(String):: Finds a dependency by name. Throws an exception if it can't be found.
