...
The `dependencyManagement` block will suggest/force dependency versions for all configurations. You ccan disable this feature
...
org.kordamp.gradle.base.dependency.management:: Suggest/force dependency versions. Defaults to `true`.
