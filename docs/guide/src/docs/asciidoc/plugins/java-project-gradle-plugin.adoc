...
Configures platform dependencies based on settings available from `config.dependencies`. Since Gradle 6 platform dependencies
...
Configures platform, module, and regular dependencies based on settings available from `config.dependencies`.
