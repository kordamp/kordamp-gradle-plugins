 ...
 */
@CompileStatic
interface ResolvedJavadoc extends ResolvedFeature {
    ...
    @CompileStatic
    interface ResolvedAutoLinks {
        Map<String, Map<String, Object>> toMap()

        Provider<Boolean> getEnabled()

        Provider<Boolean> getUseJavadocIo()

        Provider<Set<String>> getExcludes()

        Provider<Set<String>> getConfigurations()
