...
class MutableImplementation implements Implementation {
    ...
    MutableImplementation copyOf() {
        MutableImplementation copy = new MutableImplementation()
    ...
    static void merge(MutableImplementation o1, MutableImplementation o2) {
