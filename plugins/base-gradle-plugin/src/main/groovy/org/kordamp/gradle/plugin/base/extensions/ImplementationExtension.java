...
public interface ImplementationExtension extends ExtensionAware {

    String NAME = "implementation";
    ExtensionPath<InfoExtension, ImplementationExtension> PATH = InfoExtension.PATH.append(NAME, ImplementationExtension.class);

    Property<Boolean> getEnabled();
    Property<String> getTitle();
    Property<String> getVersion();
    Property<String> getVendor();
    Property<String> getVendorId();
    ...
    static ImplementationExtension create(Project project) {
        return ExtensionUtil.create(project, PATH, (ext, root) -> {
            ...
            ext.getVendorId().convention(root.getVendorId());
