 ...
 */
@CompileStatic
interface ResolvedTesting extends ResolvedFeature {
    String PLUGIN_ID = 'org.kordamp.gradle.testing'

    Provider<Boolean> getLogging()

    Provider<Boolean> getAggregate()
    ...
    @CompileStatic
    interface ResolvedIntegration extends ResolvedFeature {
        ...
        Provider<String> getBaseDir()
    }

    @CompileStatic
    interface ResolvedFunctional extends ResolvedFeature {
