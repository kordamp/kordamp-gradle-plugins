 ...
 * The following licenses are defined by Bintray and do not have a matching SPDX entry
 * <pre>
 * Attribution
 * Bouncy-Castle
 * Codehaus
...
enum LicenseId {
    ...
    AFL_2_1("AFL-2.1", "AFL-2.1", "Academic Free License v2.1"),
    AFL_3_0("AFL-3.0", "AFL-3.0", "Academic Free License v3.0"),
    ...
    AGPL_3_0_ONLY("AGPL-3.0-only", "AGPL-V3", "GNU Affero General Public License v3.0 only"),
    ...
    APACHE_1_0("Apache-1.0", "Apache-1.0", "Apache License 1.0"),
    APACHE_1_1("Apache-1.1", "Apache-1.1", "Apache License 1.1"),
    APACHE_2_0("Apache-2.0", "Apache-2.0", "Apache License 2.0"),
    APAFML("APAFML", "Adobe Postscript AFM License"),
    APL_1_0("APL-1.0", "APL-1.0", "Adaptive Public License 1.0"),
    ...
    APSL_2_0("APSL-2.0", "APSL-2.0", "Apple Public Source License 2.0"),
    ...
    ARTISTIC_2_0("Artistic-2.0", "Artistic-License-2.0", "Artistic License 2.0"),
    ...
    BSD_1_CLAUSE("BSD-1-Clause", "BSD", "BSD 1-Clause License"),
    ...
    BSD_2_CLAUSE("BSD-2-Clause", "BSD 2-Clause", "BSD 2-Clause 'Simplified' License"),
    ...
    BSD_3_CLAUSE("BSD-3-Clause", "BSD 3-Clause", "BSD 3-Clause 'New' or 'Revised' License"),
    ...
    BSL_1_0("BSL-1.0", "BSL-1.0", "Boost Software License 1.0"),
    ...
    CATOSL_1_1("CATOSL-1.1", "CA-TOSL-1.1", "Computer Associates Trusted Open Source License 1.1"),
    ...
    CC0_1_0("CC0-1.0", "CC0-1.0", "Creative Commons Zero v1.0 Universal"),
    CDDL_1_0("CDDL-1.0", "CDDL-1.0", "Common Development and Distribution License 1.0"),
    ...
    CPAL_1_0("CPAL-1.0", "CPAL-1.0", "Common Public Attribution License 1.0"),
    CPL_1_0("CPL-1.0", "CPL-1.0", "Common Public License 1.0"),
    CPOL_1_02("CPOL-1.02", "CPOL-1.02", "Code Project Open License 1.02"),
    ...
    ECL_2_0("ECL-2.0", "ECL2", "Educational Community License v2.0"),
    ...
    ENTESSA("Entessa", "Entessa-1.0", "Entessa Public License v1.0"),
    EPL_1_0("EPL-1.0", "EPL-1.0", "Eclipse Public License 1.0"),
    EPL_2_0("EPL-2.0", "EPL-2.0", "Eclipse Public License 2.0"),
    ERLPL_1_1("ErlPL-1.1", "Erlang Public License v1.1"),
    EUDATAGRID("EUDatagrid", "EUDATAGRID", "EU DataGrid Software License"),
    EUPL_1_0("EUPL-1.0", "European Union Public License 1.0"),
    EUPL_1_1("EUPL-1.1", "EUPL-1.1", "European Union Public License 1.1"),
    EUPL_1_2("EUPL-1.2", "EUPL-1.2", "European Union Public License 1.2"),
    EUROSYM("Eurosym", "Eurosym License"),
    FAIR("Fair", "Fair", "Fair License"),
    FRAMEWORX_1_0("Frameworx-1.0", "Frameworx-1.0", "Frameworx Open License 1.0"),
    ...
    GPL_2_0_ONLY("GPL-2.0-only", "GPL-2.0", "GNU General Public License v2.0 only"),
    GPL_2_0_OR_LATER("GPL-2.0-or-later", "GNU General Public License v2.0 or later"),
    GPL_2_0_WITH_CLASSPATH_EXCEPTION("GPL-2.0-with-classpath-exception", "GPL-2.0+CE", "GNU General Public License v2.0 w/Classpath exception"),
    GPL_3_0_ONLY("GPL-3.0-only", "GPL-3.0", "GNU General Public License v3.0 only"),
    ...
    ICU("ICU", "ICU License"),
    IJG("IJG", "IJG", "Independent JPEG Group License"),
    IMAGEMAGICK("ImageMagick", "ImageMagick", "ImageMagick License"),
    ...
    IPA("IPA", "IPAFont-1.0", "IPA Font License"),
    IPL_1_0("IPL-1.0", "IBM Public License v1.0"),
    ISC("ISC", "ISC", "ISC License"),
    JASPER_2_0("JasPer-2.0", "JasPer License"),
    JSON("JSON", "JSON", "JSON License"),
    ...
    LGPL_2_0_ONLY("LGPL-2.0-only", "LGPL-2.0", "GNU Library General Public License v2 only"),
    LGPL_2_0_OR_LATER("LGPL-2.0-or-later", "GNU Library General Public License v2 or later"),
    LGPL_2_1_ONLY("LGPL-2.1-only", "LGPL-2.1", "GNU Lesser General Public License v2.1 only"),
    LGPL_2_1_OR_LATER("LGPL-2.1-or-later", "GNU Lesser General Public License v2.1 or later"),
    LGPL_3_0_ONLY("LGPL-3.0-only", "LGPL-3.0", "GNU Lesser General Public License v3.0 only"),
    ...
    LIBPNG("Libpng", "Libpng", "libpng License"),
    ...
    LPPL_1_0("LPPL-1.0", "LPPL-1.0", "LaTeX Project Public License v1.0"),
    ...
    MIROS("MirOS", "MirOS", "MirOS License"),
    ...
    MOTOSOTO("Motosoto", "Motosoto-0.9.1", "Motosoto License"),
    MPICH2("mpich2", "mpich2 License"),
    MPL_1_0("MPL-1.0", "Mozilla Public License 1.0"),
    MPL_1_1("MPL-1.1", "Mozilla-1.1", "Mozilla Public License 1.1"),
    MPL_2_0_NO_COPYLEFT_EXCEPTION("MPL-2.0-no-copyleft-exception", "Mozilla Public License 2.0 (no copyleft exception)"),
    MPL_2_0("MPL-2.0", "MPL-2.0", "Mozilla Public License 2.0"),
    MS_PL("MS-PL", "MS-PL", "Microsoft Public License"),
    MS_RL("MS-RL", "MS-RL", "Microsoft Reciprocal License"),
    MTLL("MTLL", "Matrix Template Library License"),
    MULTICS("Multics", "Multics", "Multics License"),
    MUP("Mup", "Mup License"),
    NASA_1_3("NASA-1.3", "NASA-1.3", "NASA Open Source Agreement 1.3"),
    NAUMEN("Naumen", "NAUMEN", "Naumen Public License"),
    NBPL_1_0("NBPL-1.0", "Net Boolean Public License v1"),
    NCSA("NCSA", "NCSA", "University of Illinois/NCSA Open Source License"),
    ...
    NOKIA("Nokia", "Nokia-1.0a", "Nokia Open Source License"),
    NOSL("NOSL", "NOSL-3.0", "Netizen Open Source License"),
    ...
    NRL("NRL", "NRL License"),
    NTP("NTP", "NTP", "NTP License"),
    OCCT_PL("OCCT-PL", "Open CASCADE Technology Public License"),
    OCLC_2_0("OCLC-2.0", "OCLC-2.0", "OCLC Research Public License 2.0"),
    ...
    OFL_1_1("OFL-1.1", "Openfont-1.1", "SIL Open Font License 1.1"),
    ...
    RPL_1_5("RPL-1.5", "RPL-1.5", "Reciprocal Public License 1.5"),
    ...
    SPL_1_0("SPL-1.0", "SUNPublic-1.0", "Sun Public License v1.0"),
    ...
    TMATE("TMate", "TMate", "TMate Open Source License"),
    ...
    UNICODE_DFS_2015("Unicode-DFS-2015", "Unicode-DFS-2015", "Unicode License Agreement - Data Files and Software (2015)"),
    ...
    UNLICENSE("Unlicense", "Unlicense", "The Unlicense"),
    UPL_1_0("UPL-1.0", "UPL-1.0", "Universal Permissive License v1.0"),
    VIM("Vim", "VIM License", "Vim License"),
    ...
    ZPL_2_0("ZPL-2.0", "ZPL-2.0", "Zope Public License 2.0"),
    ZPL_2_1("ZPL-2.1", "Zope Public License 2.1");

    private String spdx
    private String bintray
