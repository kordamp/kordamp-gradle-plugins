 ...
 */
@CompileStatic
interface ResolvedSourceXref extends ResolvedAggregatingFeature {
    String PLUGIN_ID = 'org.kordamp.gradle.source-xref'

    Provider<String> getTemplateDir()

    Provider<String> getInputEncoding()

    Provider<String> getOutputEncoding()
