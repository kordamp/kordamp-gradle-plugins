 ...
 */
@CompileStatic
interface ResolvedSonar extends ResolvedFeature {
    String PLUGIN_ID = 'org.kordamp.gradle.sonar'

    Provider<Boolean> getIgnoreFailures()

    Provider<String> getHostUrl()

    Provider<String> getUsername()

    Provider<String> getProjectKey()
