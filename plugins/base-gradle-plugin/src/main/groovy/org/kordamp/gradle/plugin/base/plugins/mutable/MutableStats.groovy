...
class MutableStats extends AbstractFeature implements Stats {
    ...
    void copyInto(MutableStats copy) {
        super.copyInto(copy)
    ...
    static void merge(MutableStats o1, MutableStats o2) {
