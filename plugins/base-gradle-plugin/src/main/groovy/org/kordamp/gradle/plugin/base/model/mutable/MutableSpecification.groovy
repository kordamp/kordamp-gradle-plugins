...
class MutableSpecification implements Specification {
    ...
    MutableSpecification copyOf() {
        MutableSpecification copy = new MutableSpecification()
    ...
    static void merge(MutableSpecification o1, MutableSpecification o2) {
