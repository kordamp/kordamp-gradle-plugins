...
class MutableGroovydoc extends AbstractFeature implements Groovydoc {
    ...
    MutableGroovydoc(Project project) {
        super(project)
    ...
    void copyInto(MutableGroovydoc copy) {
        super.copyInto(copy)
    ...
    @CompileDynamic
    static void merge(MutableGroovydoc o1, MutableGroovydoc o2) {
