...
class MutableSourceXref extends AbstractFeature implements SourceXref {
    String templateDir
    ...
    MutableSourceXref(Project project) {
        super(project)
    ...
    void copyInto(MutableSourceXref copy) {
        super.copyInto(copy)
    ...
    @CompileDynamic
    static void merge(MutableSourceXref o1, MutableSourceXref o2) {
