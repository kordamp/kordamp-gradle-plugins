...
import org.kordamp.gradle.plugin.base.model.mutable.MutableCredentials
...
class MutableBintray extends AbstractFeature implements Bintray {
    ...
    void copyInto(MutableBintray copy) {
        super.copyInto(copy)
    ...
    static void merge(MutableBintray o1, MutableBintray o2) {
