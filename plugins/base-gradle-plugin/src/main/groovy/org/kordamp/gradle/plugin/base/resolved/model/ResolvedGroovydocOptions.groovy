 ...
 */
@CompileStatic
interface ResolvedGroovydocOptions {
    ...
    Provider<TextResource> getOverviewText()

    Provider<Boolean> getNoTimestamp()

    Provider<Boolean> getNoVersionStamp()

    Provider<Boolean> getIncludePrivate()

    Provider<Boolean> getUse()

    Provider<Set<Groovydoc.Link>> getLinks()
