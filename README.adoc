...
image:https://api.bintray.com/packages/aalmiray/kordamp/base-gradle-plugin/images/download.svg[link="https://bintray.com/aalmiray/kordamp/base-gradle-plugin/_latestVersion"]
