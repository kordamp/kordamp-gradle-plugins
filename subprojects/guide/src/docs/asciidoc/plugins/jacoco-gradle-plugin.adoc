...
.Properties
[horizontal]
additionalSourceDirs:: project.sourceSets.main.allSource.srcDirs
sourceDirectories:: project.sourceSets.main.allSource.srcDirs
classDirectories:: project.sourceSets.main.output.classesDirs*.path
